...
namespace Fractals.Visualization.OpenTK
{
    // Be warned, there is a LOT of stuff here. It might seem complicated, but just take it slow and you'll be fine.
    // OpenGL's initial hurdle is quite large, but once you get past that, things will start making more sense.
    public abstract class GWindow : GameWindow
    {
        ...
        public GWindow(GameWindowSettings gameWindowSettings, NativeWindowSettings nativeWindowSettings)
            : base(gameWindowSettings, nativeWindowSettings)
        {
        }

        protected abstract void LoadCore();
        protected abstract void OnRenderFrameCore();
    ...
    public class Window : GWindow
    {
        ...
        protected override void OnRenderFrameCore()
        {
        }
    }
}