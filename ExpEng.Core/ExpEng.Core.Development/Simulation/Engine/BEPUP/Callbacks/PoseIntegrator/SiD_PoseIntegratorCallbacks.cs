...
namespace ExpEng.Core.Development.Simulation.Engine.BEPUP.Callbacks.PoseIntegrator
{

    //..AG..Start with gravity. chain with others.
    //have to be careful about how complex callbacks become 
    //porting in demo callbacks from api demo, should model gravity well enough
    
    public struct SiD_PoseIntegratorCallbacks : ISiD_PoseIntegratorCallbacks
    {
        /// <summary>
        ...
        public SiD_PoseIntegratorCallbacks(Vector3 gravity, float linearDamping = .03f, float angularDamping = .03f) : this()
        {
            Gravity = gravity;
    ...
    public interface ISiD_PoseIntegratorCallbacks : IPoseIntegratorCallbacks { }
}
